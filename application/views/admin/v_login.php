  ...
  <body class="d-flex align-items-center">
    <div class="col-sm-12"> <br><br><br><br><br><br> </div>
              ...
              <div class="animate form-login">
                <section class="">
                  <form action="<?php echo site_url('/administrator/auth')?>" method="POST">
                    <h3 class="text-danger"><i class="fa fa-map-marker"></i> AstegShop</h3>
                    <h1>Login Form <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'></a>
                    </h1>
        ...
        <div class="col-md-6 d-xs-none">
          <img src="<?php echo base_url('assets/images/toko.jpeg')?>" width="85%">
        </div>
  </body>
