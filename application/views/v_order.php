                          ...
                          <div class="col-sm-12">
                            <div class="card" style="width: 1050px;">
                              <div class="card-block">
                                <h3 class="card-title text-center"> Silahkan Transfer Ke Rekeninng Atauompet Digital Berikut</h3><hr>
                                <card class="text-center">
                                <p class="card-text">No Rekening : 4545478341154</p>
                                <p class="card-text">BANK : Mandiri</p>
                                <p class="card-text">OVO / GOPAY / DANA : 089649349355</p>
                                </card>
                              </div>
                            </div>
                          </div>
